...
def main(SWD=False):
    ...
    if SWD:
        optimizer = stochastic_weight_decay(model, optimizer)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_top1_acc, train_top5_acc = train(train_loader, model, criterion, optimizer, epoch)

        # evaluate on validation set
        val_top1_acc, val_top5_acc = validate(val_loader, model, criterion)
        prec1 = val_top1_acc

        train_top1.append(train_top1_acc)
        train_top5.append(train_top5_acc)
        val_top1.append(val_top1_acc)
        val_top5.append(val_top5_acc)
    ...
    plot_accuracies(train_top1, train_top5, val_top1, val_top5, SWD)
...
def stochastic_weight_decay(model, optimizer):
    ...
    params_reg, params_unreg = [], []

    current_lr = optimizer.param_groups[0]['lr']

    for include, p in zip(include_in_regularized, model.parameters()):
        if include == 1:
            params_reg.append(p)
        else:
